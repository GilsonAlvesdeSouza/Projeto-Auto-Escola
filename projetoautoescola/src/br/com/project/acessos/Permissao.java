...
public enum Permissao {
	...
	FINACEIRO_ACESSAR("FINACEIRO_ACESSAR", "Financeiro - Acessar"),
	MENSSAGEM_ACESSAR("MENSSAGEM_ACESSAR", "menssagem recebida - acessar"),
	...
	/**
	 * Método que retorna uma lista com todos os enums ordenados
	 * 
	 * @return
	 */
	public static List<Permissao> getListPermissao() {
		...
		Collections.sort(permissoes, new Comparator<Permissao>() {
			...
			public int compare(Permissao o1, Permissao o2) {
				...
				return new Integer(o1.ordinal()).compareTo(new Integer(o1.ordinal()));
			}
		});
		return permissoes;
	}
