...
public class CarregamentoLazyListForObject<T> extends LazyDataModel<T> {
	...
	private Controller controller = (Controller) ContextLoaderListenerAutoEscolaUtils.getBean(Controller.class);
	...
	public List<T> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
		try {
			...
			if (query != null && !query.isEmpty()) {
				list = (List<T>) controller.findByQueryDinamic(query, first, pageSize);
	...
	public void setTotalResgistroConsulta(int totalResgistroConsulta, String queryDeBuscaConsulta) {
